...
class CredimaxPaymentGateway
{
    ...
    {        
        $data = [
            ...
            "currency_code" => "BD",
            "payment_type" => 2,
            "success_redirect_url" => config('webconfig.credimax_payment_gateway_success_url')."?is_web=$this->is_web&order_id=$this->orderId",
            "failed_redirect_url" => config('webconfig.credimax_payment_gateway_failure_url')."?is_web=$this->is_web&order_id=$this->orderId",
        ];
