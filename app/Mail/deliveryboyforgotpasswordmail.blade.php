			     ...
			     <tr>
			       <td valign="middle" style="background-color:#fc2217; color:#fff; padding:15px 20px; border-top-left-radius:8px; border-top-right-radius:8px">
				     <h1 style="margin:0px; line-height:normal; font-weight:300; font-size:22px">
					   Get Your <b style="font-weight:500">Password
					 </h1>
			       </td>
			     </tr>
				 <tr>
				     ...
				     <tbody>
					   <tr>
					     <td style="padding:20px 20px 15px 20px;">
							...
							<p style="margin:0px 0px;">We have received your forgot password request.Kindly access your account with this temperory password <b style="color:#fc2217">{{ $reset_password }}</b>. Please change your password after login. As per your request about password issue we have changed your password temporarily.</p>
					     </td>
					   </tr>
					 </tbody>
				     </table>					 
