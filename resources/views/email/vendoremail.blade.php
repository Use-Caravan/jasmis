				     ...
				     <tbody>
					   <tr>
					     <td style="padding:20px 20px 15px 20px;">
							...
							<p style="margin:0px 0px;">Admin created you as a <b style="color:#fc2217">Vendor</b>
						    ...
						    <td style="background-color:#fff; border: 1px solid #d3d4d8;">
							  <table cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
                                    ...
                                    <p style="margin:0px 0px 5px 0px;">Login Url - <a href="{{ url('app/vendor/login') }}" style="color:#15c;"><b>Click here</b></a></p>
