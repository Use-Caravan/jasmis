				     ...
				     <tbody>
					   <tr>
					     <td style="padding:20px 20px 15px 20px;">
							<p style="margin:0px 0px 10px 0px;">Dear <b>{{ $user }}</b>, </p>
                         <p style="margin:0px 0px 5px 0px;">We have received your forgot password request. Kindly change your account password. <b style="color:#fc2217">Click <a href="{{ $url }}">here</a> to reset password</b></p>
					     </td>
					   </tr>
					 </tbody>
				     </table>
