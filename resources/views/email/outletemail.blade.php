				     ...
				     <tbody>
					   <tr>
					     <td style="padding:20px 20px 15px 20px;">
							<p style="margin:0px 0px 10px 0px;">Dear <b>{{ $branchName['en'] }}</b>, </p>
                            @if(auth()->guard(GUARD_ADMIN)->check())
							<p style="margin:0px 0px;">Admin created you as a <b style="color:#fc2217">Outlet</b>
                            @elseif(auth()->guard(GUARD_VENDOR)->check())
                            <p style="margin:0px 0px;">Vendor created you as a <b style="color:#fc2217">Outlet</b>
                            @endif
. You can access your account by using the below details.</p>
					     </td>
					   </tr>
					 </tbody>
				     </table>
						    ...
						    <td style="background-color:#fff; border: 1px solid #d3d4d8;">
							  <table cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
                                    ...
                                    <p style="margin:0px 0px 5px 0px;">Login Url - <a href="{{ url('app/outlet/login') }}" style="color:#15c;"><b>Click here</b></a></p>
