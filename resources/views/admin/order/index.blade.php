                ...
                <thead>
                    ...
                    <tr>
                       ...
                       <th>
                        ...
                        <th>
                            {{ Form::select('payment_type', $model->paymentTypes(), '' ,['class' => 'selectpicker filterSelect ', 'placeholder' => __('admincommon.All'), "data-name" => "5"] )}} 
                        </th>                        
                        <th>
                        ...
                        <th>
                            {{ Form::select('order_status', $model->approvedStatus(), '' ,['class' => 'filterSelect selectpicker', 'placeholder' => __('admincommon.All'), "data-name" => "7"] )}} 
                        </th>
                        <th class="status">
...
$(document).ready(function() {
    ...
    $('body').on('change','.order_status select',function (e) {
        ...
        $.ajax({
            url: "{{url(route('order.approvedstatus'))}}",
            type: 'POST',
