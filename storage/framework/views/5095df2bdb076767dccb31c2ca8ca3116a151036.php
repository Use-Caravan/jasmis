		   ...
		   <td>
		     <table cellpadding="0" cellspacing="0" width="100%" border="0" align="center" style="box-shadow: 0px 0px 25px rgba(0, 0, 0, 0.15); border-top-left-radius:8px; border-top-right-radius:8px">
		       <tbody>
			     <tr>
			       <td valign="middle" style="background-color:#fc2217; color:#fff; padding:15px 20px; border-top-left-radius:8px; border-top-right-radius:8px">
				     <h1 style="margin:0px; line-height:normal; font-weight:300; font-size:22px">
					   Get Your <b style="font-weight:500">Password</b>
					 </h1>
			       </td>
			     </tr>
				 <tr>
				     ...
				     <tbody>
					   <tr>
					     <td style="padding:20px 20px 15px 20px;">
							<p style="margin:0px 0px 10px 0px;">Dear <b><?php echo e($user); ?></b>, </p>
                         <p style="margin:0px 0px 5px 0px;">We have received your forgot password request. Kindly change your account password. <b style="color:#fc2217">Click <a href="<?php echo e($url); ?>">here</a> to reset password</b></p>
					     </td>
					   </tr>
					 </tbody>
				     </table>
			     ...
			     <tr>
				   <td style="padding:15px 20px; background:#f2f2f2; text-align:center; border: 1px solid #c1c2c7; border-top: 0px; border-bottom: 0px;">
				    <p style="margin:0px 0px 5px 0px; font-weight:500; color:#fc2217">"When you are lost, I will shine a light"</p>
				   </td>
			     </tr>
				 <tr>
			       <td valign="middle" style="background-color:#fc2217; color:#fff; padding:15px 20px; border-bottom-left-radius:8px; border-bottom-right-radius:8px">
				     <table cellpadding="0" cellspacing="0" width="100%" border="0">
						<td><span style="font-weight:300; font-size:13px">Best Regards,</span><br>The <?php echo e(config('webconfig.app_name')); ?> Team.</td>
		   ...
		   <td valign="middle" style="padding:15px 20px; text-align:center">
			 <table cellpadding="0" cellspacing="0" width="100%" border="0">
				<td>
					...
					<a target="_blank" href="<?php echo e(config('webconfig.social_twitter')); ?>"><img src="<?php echo e(asset('resources/assets/icons/facebook.png')); ?>" style="margin:2px"></a>
                    <a target="_blank" href="<?php echo e(config('webconfig.social_facebook')); ?>"><img src="<?php echo e(asset('resources/assets/icons/twitter.png')); ?>" style="margin:2px"></a>
                    <a target="_blank" href="<?php echo e(config('webconfig.social_instagram')); ?>"><img src="<?php echo e(asset('resources/assets/icons/instagram.png')); ?>" style="margin:2px"></a>
				</td>
			 </table>
		   </td>
		 </tr>			 
