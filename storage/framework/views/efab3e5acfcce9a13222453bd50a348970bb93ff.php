...
<?php
  $url = route('vendor.update', ['id' => $model->vendor_key]);
?>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-info">
          ...
          <?php echo $__env->make('admin.vendors._form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
      </div>
    </div>
  </section>
