...
<?php
  $url = route('cuisine.update', ['id' => $model->cuisine_key]);
?>
    ...
    <div class="row">
      <div class="col-md-offset-2 col-md-6">
        <div class="box box-info">
          ...
          <?php echo $__env->make('admin.cuisine._form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
      </div>
    </div>
  </section>
