...
<?php
  $url = route('loyaltypoint.update', ['id' => $model->loyalty_point_key]);
?>
    ...
    <div class="row">
      <div class="col-md-offset-2 col-md-6">
        <div class="box box-info">
          ...
          <?php echo $__env->make('admin.loyaltypoint._form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
      </div>
    </div>
  </section>
