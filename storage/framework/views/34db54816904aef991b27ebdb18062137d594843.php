  ...
  <section class="content">
    <div class="box">
        ...
        <?php echo $__env->make('admin.layouts.partials._flashmsg', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          <h1 class="box-title"><?php echo app('translator')->getFromJson('admincrud.Country Management'); ?></h1>
           <div class="top-action">
            <a href="<?php echo route('country.create'); ?>" title="Add New" class="btn mb15"><i class="fa fa-plus-circle"></i><?php echo app('translator')->getFromJson('admincommon.Add New'); ?></a>
          </div>
        </div> <!--box-header-->
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped" id="dataTable">
              ...
              <tr>
                    ...
                    <th><?php echo app('translator')->getFromJson('admincrud.Country Code'); ?></th>                  
              ...
              <tr>
                    ...
                    <th>
                        <?php echo e(Form::text("country_code", '', ['class' => 'form-control filterText', "placeholder" =>__('admincrud.Country Code'), "data-name" => "2"])); ?>

                    </th>  
                    <th class="status">
                        <?php echo e(Form::select('status', Common::status(), '' ,['class' => 'selectpicker filterSelect', 'placeholder' => __('admincommon.All'), "data-name" => "3"] )); ?>
...
$(document).ready(function(){
    window.dataTable = $('#dataTable').dataTable({
        'ajax' : "<?php echo e(route('country.index')); ?>",
        'columns': [
