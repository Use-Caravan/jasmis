...
<div class="full_row">
    ...
    <div class="side-categories wow fadeInUp">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#all_items<?php echo e($branchDetails->branch_key); ?>" role="tab"><?php echo e(__('All')); ?></a>
            </li>
            <?php $__currentLoopData = $itemDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($value->items != null): ?> 
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#a_<?php echo e($value->category_key); ?>" data-categorykey="<?php echo e($value->category_key); ?>" data_category_id="<?php echo e($value->category_id); ?>" id="category_id" role="tab"><?php echo e($value->category_name); ?></a>
                    </li>    
                <?php endif; ?>
    ...
    <div class="main-menu wow fadeInUp">
        ...
        <div class="item-search full_row">
            ...
            <input type="text" placeholder=<?php echo app('translator')->getFromJson("Search Menu Items"); ?> id = "item-search">
        </div>
        <!-- item container -->
        <div class="item-container">
            <!-- Tab panes -->
            <div class="tab-content">
                <div class="tab-pane active" id="all_items<?php echo e($branchDetails->branch_key); ?>" role="tabpanel">
                    <div class="row" id="item_search">
                        <?php $__currentLoopData = $itemDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($value->items !== null): ?>
                                <?php $__currentLoopData = $value->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iKey => $iValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo view('frontend.branch.item')->with('iValue',$iValue)->with('branchDetails',$branchDetails)->render(); ?>
                ...
                <?php $__currentLoopData = $itemDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($value->items !== null): ?>
                    <div class="tab-pane" id="a_<?php echo e($value->category_key); ?>" role="tabpanel">
                        <h3 class="m-title"><?php echo e($value->category_name); ?></h3>
                        <div class="row" id="html_<?php echo e($value->category_key); ?>">
                            <?php $__currentLoopData = $value->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iKey => $iValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo view('frontend.branch.item')->with('iValue',$iValue)->with('branchDetails',$branchDetails)->render(); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                <span> <h2 class="heading-1"><?php echo e(__('No Items Found.')); ?><h2></span>
                <?php endif; ?>
            </div>
            <!-- Tab panes -->
        </div>
            ...
            <div class="modal-body">                    
                <div class="form-box floating_label">
                    ...
                    <div class="text-right mb-5">                                                
                        ...
                        <?php echo Html::decode( Form::button('<span class="shape">Ok</span>', ['type'=>'button', "id" => "cart_clear_confirm","updated-branchkey" => '', 'class' => 'shape-btn shape1']) ); ?>
...
$('document').ready(function(){
    ...
    $('body').on('click','.addItemIngredient',function() {
        ...
        $.ajax({ 
            url:  "<?php echo e(route('frontend.item.show',[''])); ?>/"+itemKey,
            type: 'GET',
    ...
    $('body').on('click','.ingredients',function() {
        ...
        if(ingredientCount > maximum) {
            ...
            errorCount++;
            errorNotify("<?php echo e(__('You have selected maximum ingredients')); ?>");
            return false;
        }   
        
        if(ingredientCount < minimum) {                
            errorCount++;
            errorNotify("<?php echo e(__('You have to choose atleast minimum ingredient')); ?>");
            return false;
        } 
    ...
    $('body').on('click','#add_to_cart',function() {
        ...
        $('.ingredient_groups').each(function() {
            ...
            var errorCount = 0;
            if(ingredientCount > maximum) {
                $('#error'+groupKey).html("<?php echo e(__('You have selected maximum ingredients')); ?>");
                errorCount++;
                totalErrorCount++;
            }
            if(ingredientCount < minimum) {
                errorCount++;
                totalErrorCount++;
                $('#error'+groupKey).html("<?php echo e(__('You have to choose atleast minimum ingredient')); ?>");
            } 
            if(errorCount == 0) {
                $('#error'+groupKey).html("");
            }
    ...
    $('#item-search').on('keyup',function(){
        ...
        $.ajax({
            type : 'get',
            url : "<?php echo e(route('frontend.item.index')); ?>",            
...
function userCart(ths,ingredients = [],haveIngredient = 0) {
    ...
    if(quantity <= 0){
        errorNotify("<?php echo e(__('Please choose atleast one quantity to add in to cart')); ?>");
        return ;
    }
...
function cartUpdate(branch_key, item_key, quantity, ingrdient_groups = [], haveIngredient) {    
    ...
    $.ajax({ 
        url: "<?php echo e(route('frontend.cart-update')); ?>",
        type: 'post',
        dataType: 'json',
        processData: false,
