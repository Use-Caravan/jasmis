  ...
  <section class="content">
    <div class="box">
        ...
        <?php echo $__env->make('admin.layouts.partials._flashmsg', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          <h1 class="box-title"><?php echo app('translator')->getFromJson('admincrud.Ingredient Management'); ?></h1>
        <div class="top-action">
            <a href="<?php echo route('ingredient.create'); ?>" title="Add New" class="btn mb15"><i class="fa fa-plus-circle"></i><?php echo app('translator')->getFromJson('admincommon.Add New'); ?></a>
          </div>
            ...
            <table class="table table-bordered table-striped" id="dataTable">
              <thead>
                <tr>
                    ...
                    <th><?php echo app('translator')->getFromJson('admincrud.Ingredient Name'); ?></th>                  
                    <th><?php echo app('translator')->getFromJson('admincrud.Sort No'); ?></th>                  
                    <th><?php echo app('translator')->getFromJson('admincommon.Created Date'); ?></th>
                ...
                <tr>
                    <th></th>
                    <th>
                        <?php echo e(Form::text("ingredient_name", '', ['class' => 'form-control filterText', "placeholder" =>__('admincrud.Ingredient Name'), "data-name" => "1"])); ?>                         
                    </th>
                    <th>
...
$(document).ready(function(){
    window.dataTable = $('#dataTable').dataTable({
        'ajax' : "<?php echo e(route('ingredient.index')); ?>",
        'columns': [
